...
public class SoundRegistry {
    ...
    public static DeferredHolder<SoundEvent, SoundEvent> MUSIC_FIRE_BOSS_BASS_A = registerSoundEvent("music.fire_boss.bass_a");
    public static DeferredHolder<SoundEvent, SoundEvent> MUSIC_FIRE_BOSS_DRUMS_A = registerSoundEvent("music.fire_boss.drums_a");
    public static DeferredHolder<SoundEvent, SoundEvent> MUSIC_FIRE_BOSS_DRUMS_B = registerSoundEvent("music.fire_boss.drums_b");
    public static DeferredHolder<SoundEvent, SoundEvent> MUSIC_FIRE_BOSS_ORCHESTRA = registerSoundEvent("music.fire_boss.orchestra");
    public static DeferredHolder<SoundEvent, SoundEvent> MUSIC_FIRE_BOSS_MELODY = registerSoundEvent("music.fire_boss.melody");
    public static DeferredHolder<SoundEvent, SoundEvent> MUSIC_FIRE_BOSS_CHOIR = registerSoundEvent("music.fire_boss.choir");
